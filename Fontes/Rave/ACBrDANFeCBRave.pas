...
uses ACBrDANFeCBRavePaisagem, ACBrDANFeCBRaveRetrato, ACBrDANFeEventoRaveRetrato,
     ACBrDANFeInutilRaveRetrato, ACBrNFeDANFERaveCB;
...
begin
  with BaseReport do begin
    ...
    if aTitle<>'' then begin
       ...
       GotoXY(XX,YY);
       NewLine;
       PrintXY(XX+1,YPos-0.4,UpperCase(aTitle)); //deixa maiusculo
       NewLine;
       SetFontText;
